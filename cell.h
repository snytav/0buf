...
void MoveSingleParticle(unsigned int i, CellTotalField cf,int nt)
{
 ...
 __host__ __device__
 #endif
 DoubleCurrentTensor AccumulateCurrentSingleParticle(unsigned int i,int *cells,DoubleCurrentTensor *dt,int nt)
 {
	 Particle p;
//	 DoubleCurrentTensor dt;
	 ...
	 if((blockIdx.x == 80 && blockIdx.y == 3 && blockIdx.z == 3 ))
	        ...
	        {
	                 printf("CHE20Ac index %5d  nt %5d sort %2d x %22.15e x1 %22.15e \n",//block ( %d,%d,%d ) thread ( %d,%d,%d ) \n",
	                                                   i,
	                                                   nt,
	                                                   p.sort,
	                                                   p.x,
	...
	//                                                // i,l,k,
	 ...
	 if((blockIdx.x == 80 && blockIdx.y == 3 && blockIdx.z == 3 ))
	 	                //&& (threadIdx.x == 2 && threadIdx.y == 3 && threadIdx.z == 3))
	 	        {
	 	                 printf("CHE20Ad index %5d  nt %5d sort %2d x %22.15e x1 %22.15e \n",//block ( %d,%d,%d ) thread ( %d,%d,%d ) \n",
	 	                                                   i,
	 	                                                   nt,
	 	                                                   p.sort,
	 	                                                   p.x,
